/*3. Write a program which return addition of all even elements from singly linear linked list.
...
int main()
{
    ...
    printf("Addition of the even elements from linked list is : %d", iRet);
