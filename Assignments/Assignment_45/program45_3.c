...
int main()
{
    ...
    int iFirstOccur = 0, iLastOccur = 0; 
    bool bRet = false;
    ...
    printf("Enter the element to find there first occurance : \n");
    scanf("%d", &iValue);

    iFirstOccur = FirstOccur(head, iValue);
    printf("First occurance of %d is : %d\n", iValue, iFirstOccur);

    printf("Enter the element to find there Last occurance : \n");
    scanf("%d", &iValue);

    iLastOccur = LastOccur(head, iValue);
